...
namespace NineGrid.Presentation.Interaction
{
    ...
    [MovedFrom(true, "NineGrid.Presentation.Performance", null, "SelectionOptionHoverPerformance")]
    public sealed class SelectionOptionHoverPresenter : MonoBehaviour, IInteractivePresenter
    {
