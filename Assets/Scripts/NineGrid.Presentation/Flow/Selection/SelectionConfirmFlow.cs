...
namespace NineGrid.Presentation.Flow.Selection
{
    ...
    [MovedFrom(true, "NineGrid.Presentation.Performance", null, "SelectionOptionConfirmPerformance")]
    public sealed class SelectionConfirmFlow : MonoBehaviour, IDirectedFlow
    {
        [Header("Lift")]
        ...
        public float ExpectedDuration => liftDuration + (moveDelay + moveDuration);
