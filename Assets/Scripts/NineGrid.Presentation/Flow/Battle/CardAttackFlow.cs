...
namespace NineGrid.Presentation.Flow.Battle
{
    ...
    [MovedFrom(true, "NineGrid.Presentation.Performance", null, "CardAttackPerformance")]
    public sealed class CardAttackFlow : MonoBehaviour, IDirectedFlow
    {
        ...
        private HitFlashCue enemyHitFlash;
        ...
        {
            enemyHitFlash = enemy.GetComponent<HitFlashCue>();
            if (enemyHitFlash == null)
            {
                enemyHitFlash = enemy.gameObject.AddComponent<HitFlashCue>();
            }
        ...
        private void PlayEnemyHitFlashOn(Transform enemy)
        {
            ...
            HitFlashCue flash = enemyHitFlash;
            if (flash == null || flash.gameObject != enemy.gameObject)
            {
                flash = enemy.GetComponent<HitFlashCue>();
                if (flash == null)
                {
                    flash = enemy.gameObject.AddComponent<HitFlashCue>();
                }
