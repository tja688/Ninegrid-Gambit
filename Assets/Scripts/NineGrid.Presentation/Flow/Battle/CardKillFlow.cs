...
namespace NineGrid.Presentation.Flow.Battle
{
    ...
    [MovedFrom(true, "NineGrid.Presentation.Performance", null, "CardKillPerformance")]
    public sealed class CardKillFlow : MonoBehaviour, IDirectedFlow
    {
        [Header("Strike Block")]
        ...
        private static void ReleaseEnemyFlashEffects(Transform enemy)
        {
            ...
            HitFlashCue[] flashes = enemy.GetComponentsInChildren<HitFlashCue>(true);
