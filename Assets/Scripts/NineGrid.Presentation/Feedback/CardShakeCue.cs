...
namespace NineGrid.Presentation.Feedback
{
    ...
    [MovedFrom(true, "NineGrid.Presentation.Performance", null, "CardShakePerformance")]
    public sealed class CardShakeCue : MonoBehaviour, ILocalCue
    {
