...
namespace NineGrid.Presentation.Editor
{
    ...
    {
        private const string DefaultsFolder = "Assets/Scripts/NineGrid.Presentation/Cards/Effects/Defaults";
        ...
        {
            if (!AssetDatabase.IsValidFolder("Assets/Scripts/NineGrid.Presentation/Cards/Effects"))
            {
                return;
            }
