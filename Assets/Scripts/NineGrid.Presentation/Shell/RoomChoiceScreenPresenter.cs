...
namespace NineGrid.Presentation.Shell
{
    ...
    public sealed class RoomChoiceScreenPresenter : MonoBehaviour
    {
        ...
        [Header("Flows")]
        [SerializeField] private RoomChoiseInFlow inFlow;
        [SerializeField] private RoomChoiseOutFlow outFlow;
        ...
        public void OnScreenEntered()
        {
            ...
            inFlow?.Play(
                new[]
                {
                    new RoomChoiseInFlow.RoomMove(room1Card, room1Start, room1HomeWorld),
                    new RoomChoiseInFlow.RoomMove(room2Card, room2Start, room2HomeWorld),
                },
                OnEnterComplete);
        }
        ...
        public void HandleOptionConfirmed(int index)
        {
            ...
            outFlow?.Play(selected, selectedEnd, unselected, OnExitComplete);
        }
        ...
        private void WireRoomHover()
        {
            if (roomHoverPresenter == null)
            {
                return;
            }

            var actors = new RoomChoiseOptionHoverPresenter.OptionActor[2];
            if (room1Card != null)
            {
                actors[0] = new RoomChoiseOptionHoverPresenter.OptionActor(
                    room1Card,
            ...
            if (room2Card != null)
            {
                actors[1] = new RoomChoiseOptionHoverPresenter.OptionActor(
                    room2Card,
                    room2Card.localScale,
                    21);
            }

            roomHoverPresenter.SetOptions(actors);
        }
