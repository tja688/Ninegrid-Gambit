...
namespace NineGrid.Core.Tests
{
    ...
    public sealed class CoreCommandShellTests
    {
        private static readonly (Type CommandType, GameCommandKind Kind)[] s_CommandRegistry =
        {
            ...
            (typeof(ResolveBoardStabilizationCommand), GameCommandKind.ResolveBoardStabilization),
            (typeof(ResolvePostKillRotateCommand), GameCommandKind.ResolvePostKillRotate),
            (typeof(RegisterEnemyActionPhaseCommand), GameCommandKind.RegisterEnemyActionPhase),
            (typeof(ResolveNextEnemyActionCommand), GameCommandKind.ResolveNextEnemyAction),
            (typeof(ResolveEnemyActionFinaleCommand), GameCommandKind.ResolveEnemyActionFinale),
            ...
            (typeof(DiscardRelicCommand), GameCommandKind.DiscardRelic),
            (typeof(RecycleItemSlotCommand), GameCommandKind.RecycleItemSlot),
            (typeof(ApplyRecycleItemSlotCommand), GameCommandKind.ApplyRecycleItemSlot),
