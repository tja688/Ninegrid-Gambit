...
namespace NineGrid.Core
{
    ...
    public static class PresentationEventMap
    {
        private static readonly PresentationEventMapEntry[] sEntries =
        {
            ...
            Entry(CoreEventType.DamageDealt, PresentationInstructionKind.ShowDamage, PresentationEventCategory.Damage, true, true, PresentationBeat.None, "Damage", "Damage floater path — card HP/armor via HpChanged/ArmorChanged"),
            ...
            Entry(CoreEventType.CardDealt, PresentationInstructionKind.DealCard, PresentationEventCategory.Deal, true, true, PresentationBeat.None, "Card dealt", "Deal animation — initial stats via CardSpawned"),
            ...
            Entry(CoreEventType.EffectTriggered, PresentationInstructionKind.TriggerEffect, PresentationEventCategory.Effect, true, true, PresentationBeat.None, "Effect triggered", "Effect FX pulse — not card-face stats"),
            ...
            Entry(CoreEventType.AvatarAppeared, PresentationInstructionKind.ShowAvatar, PresentationEventCategory.Node, true, true, PresentationBeat.None, "Avatar appeared", "Avatar intro — initial stats via spawn/settled path"),
