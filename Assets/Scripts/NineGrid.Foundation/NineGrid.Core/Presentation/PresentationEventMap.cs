...
namespace NineGrid.Core
{
    ...
    public static class PresentationEventMap
    {
        private static readonly PresentationEventMapEntry[] sEntries =
        {
            ...
            Entry(CoreEventType.GoldModified, PresentationInstructionKind.UpdateGold, PresentationEventCategory.Economy, true, true, PresentationBeat.Impact, "Gold changed"),
            ...
            Entry(
                CoreEventType.CardRhythmFireOpened,
