        ...
        private static readonly Dictionary<string, Dictionary<int, string[]>> LayoutPanelElements =
            new Dictionary<string, Dictionary<int, string[]>>
            {
                ...
                ["大盘构型2-核心战斗面板"] = new Dictionary<int, string[]>
                {
                    ...
                    [5] = new[] { "血量图标" },
                    [6] = new[] { "攻击图标", "HpText" },
                    [7] = new[] { "防御图标", "AttackText" },
                    [8] = new[] { "金币图标", "GoldText" },
                    [9] = new[] { "RelicPanelAnchors" },
                    [10] = new[] { "Notice Text", "Leve Info Text" },
                    [12] = new[] { "CardDeckAnchors", "ArmorText" },
                },
                ["大盘构型3-选择奖励"] = new Dictionary<int, string[]>
                {
                    [2] = new[] { "跳过/继续" },
                    [3] = new[] { "Notice Text（限 62 ）", "ArmorText" },
                    [5] = new[] { "血量图标" },
                    [6] = new[] { "攻击图标", "HpText", "AttackText" },
                    [7] = new[] { "防御图标" },
                    [8] = new[] { "金币图标", "GoldText" },
                    [12] = new[] { "DeckIcon" },
                },
                ["大盘构型4-打开卡组视图"] = new Dictionary<int, string[]>
                {
                    ...
                    [8] = new[] { "金币图标" },
                    [9] = new[] { "RelicPanelAnchors" },
                    [12] = new[] { "CardDeckAnchors", "HpText", "AttackText", "ArmorText" },
                },
