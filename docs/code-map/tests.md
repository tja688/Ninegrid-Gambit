...
| `ItemStatBonusEffectTests` | #97 / #158：卡店「道具卡数值强化」（`UpgradeItemStats` → `PlayerModel.ItemStatBonus`，每购 +3）——飞刀 6→9、爆弹 4→7（#158：伤害为装配实参 `help.bomb.use.amount`）、破击锤 10→13、玩家交战伤害不叠加、火球等派生数值不叠加 |
